...
In order to support loading of multiple wallets in veles-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is veles.cpp.
...
Changes to veles.cpp
----------------------
veles.cpp is the entry point into veles-qt, and as such, will require some minor modifications to provide hooks for
