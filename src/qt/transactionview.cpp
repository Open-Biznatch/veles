                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Veles from zVeles"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVeles"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVeles));
