...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"network", "firewallfloodingwalletattackpatternadd", &firewallfloodingwalletattackpatternadd, false, false, false},
        {"network", "firewallfloodingwalletattackpatternremove", &firewallfloodingwalletattackpatternremove, false, false, false},
...
#ifdef ENABLE_WALLET
        {"veles", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use velesd, or the -server option to veles-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25520/\n";
}
