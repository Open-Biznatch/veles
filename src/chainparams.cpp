...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1535990080; // Time (GMT): Thursday, 10 May 2018 13:19:53 - (Accumulator start time - requires block height 40000)
