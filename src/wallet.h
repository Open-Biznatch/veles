...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOTMNCIFMN = 3,
    ONLY_NONDENOMINATED_NOTMNCIFMN = 4, // ONLY_NONDENOMINATED and not Masternode Collateral Amount at the same time
    ONLY_MNC = 5,                        // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    */
    ...
    void setZVelesAutoBackups(bool fEnabled)
    {
